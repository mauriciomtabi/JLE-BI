...
# Executa de Segunda a Sexta-feira às 07:30 AM
...
# Definir gatilho: Segunda a Sexta às 07:30 AM
$trigger = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Monday,Tuesday,Wednesday,Thursday,Friday -At "07:30AM"
...
try {
    ...
    Write-Output "Frequencia: Segunda a Sexta-feira às 07:30 AM"
